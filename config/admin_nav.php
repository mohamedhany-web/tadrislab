    ...
    */
    ...
    'sections' => [
        ...
        'recorded_courses' => [
            ...
            'items' => [
                [
                    'label_ar' => 'إدارة الكورسات المسجّلة',
                    'label_en' => 'Manage recorded courses',
                    'route' => 'admin.advanced-courses.index',
                    'route_is' => 'admin.advanced-courses.*',
                ],
            ],
        ],
        'content_tools' => [
        ...
        // ——— المدارس والمؤسسات ———
        // مساران: تعاقد منصة (مقاعد+لوحة جهة) | تعاقد مباشر (مدرب ينفّذ للجهة)
        'institution_accounts' => [
            'hub' => 'institutions',
            'label_ar' => 'حسابات الجهات',
            'label_en' => 'Organization accounts',
            'icon' => 'fas fa-building',
            'module' => 'schools_institutions',
            'permissions' => ['manage.institutions', 'manage.packages'],
            'note_ar' => 'مدرسة / مركز / مؤسسة — حساب واحد لكل جهة',
            'note_en' => 'School / center / institution — one account per org',
            'items' => [
                [
                    'label_ar' => 'كل المدارس والمؤسسات',
                    'label_en' => 'All schools & institutions',
        ...
        'institution_platform_access' => [
            'hub' => 'institutions',
            'label_ar' => 'تعاقد منصة · مقاعد ومتابعة',
            'label_en' => 'Platform contract · seats & tracking',
            'icon' => 'fas fa-chalkboard-teacher',
            'module' => 'schools_institutions',
            'permissions' => ['manage.institutions', 'manage.packages'],
            'note_ar' => 'تفعيل مشاركين على المنصة + لوحة منسق الجهة لرؤية التقدّم والتقارير',
            'note_en' => 'Activate participants on-platform + org coordinator portal for progress & reports',
            'items' => [
                [
                    'label_ar' => 'برامج التدريب (مقاعد)',
                    'label_en' => 'Training programs (seats)',
                ...
                [
                    'label_ar' => 'مشاريع التطوير المؤسسي',
                    'label_en' => 'Institutional development projects',
                    'route' => 'admin.institution-programs.index',
                    'route_is' => 'admin.institution-programs.*',
                ...
                [
                    'label_ar' => 'كل البرامج والمشاركين',
                    'label_en' => 'All programs & participants',
                    'route' => 'admin.institution-programs.index',
                    'route_is' => 'admin.institution-programs.*',
                    'params' => [],
                    'active_when' => ['kind' => ''],
                ...
                [
                    'label_ar' => 'تحليلات ومتابعة الأداء',
                    'label_en' => 'Insights & performance tracking',
        ...
        'institution_direct_delivery' => [
            ...
            'label_en' => 'Direct contract · coach delivery',
            'icon' => 'fas fa-handshake',
            'module' => 'schools_institutions',
            'permissions' => ['manage.users', 'manage.academic-years', 'manage.tutoring-groups', 'manage.leads', 'manage.institutions'],
            'note_ar' => 'الجهة تتعاقد عبر المنصة؛ مدرب معيَّن يقدّم الخدمة مباشرة (بدون مقاعد منصة بالضرورة)',
            'note_en' => 'Org contracts via platform; an assigned coach delivers directly (seats optional)',
            'items' => [
                [
                    'label_ar' => 'المدربون لإسناد التنفيذ',
                    'label_en' => 'Coaches for delivery assignment',
                ...
                [
                    'label_ar' => 'فرص ومدارس (مسار البيع)',
                    'label_en' => 'School/org leads (pipeline)',
                ...
                [
                    'label_ar' => 'استشارات مؤسسية',
                    'label_en' => 'Institutional consultations',
        ...
        'consultations_bookings' => [
            ...
            'items' => [
                [
                    'label_ar' => 'كل الحجوزات',
                    'label_en' => 'All bookings',
                    'route' => 'admin.consultations.index',
                    'route_is' => 'admin.consultations.index|admin.consultations.show',
                ],
                [
        ...
        'orders' => [
            ...
            'label_en' => 'Orders',
            'icon' => 'fas fa-receipt',
            'permissions' => ['manage.orders', 'manage.coupons'],
            'items' => [
                [
                    'label_ar' => 'الطلبات',
                    'label_en' => 'Orders',
        ...
        'accounting' => [
            ...
            'note_ar' => 'الحسابات والفواتير والمدفوعات والمعاملات والمصروفات والتقارير',
            'note_en' => 'Receiving accounts, invoices, payments, transactions, expenses & reports',
            'items' => [
                [
                    'label_ar' => 'الحسابات',
                    'label_en' => 'Accounts',
                    'route' => 'admin.wallets.index',
                    'route_is' => 'admin.wallets.*',
                    'permissions' => ['manage.wallets', 'view.wallets', 'manage.orders', 'manage.payments'],
                ],
                [
                    'label_ar' => 'الفواتير',
                    'label_en' => 'Invoices',
                    'route' => 'admin.invoices.index',
                    'route_is' => 'admin.invoices.*',
                ...
                [
                    ...
                    'route_is' => 'admin.expenses.*',
                    'permissions' => ['manage.expenses'],
                ],
                [
                    'label_ar' => 'تقارير المحاسبة',
                    'label_en' => 'Accounting reports',
                    'route' => 'admin.accounting.reports',
                    'route_is' => 'admin.accounting.reports*',
                    'permissions' => ['manage.invoices', 'manage.payments', 'manage.transactions', 'view.financial-reports'],
                ],
            ],
        ],
        'crm' => [
            ...
            'module' => 'crm_sales',
            'permissions' => ['manage.leads'],
            'note_ar' => 'فرص أفراد وجهات — متابعة البيع قبل التعاقد',
            'note_en' => 'Individual & org leads — pre-contract sales ops',
            'items' => [
                [
                    'label_ar' => 'لوحة مسار البيع',
                    'label_en' => 'Sales dashboard',
                    'route' => 'admin.crm.dashboard',
                    'route_is' => 'admin.crm.dashboard',
                ],
                [
                    'label_ar' => 'خط الأنابيب',
                    'label_en' => 'Pipeline',
                    'route' => 'admin.crm.pipeline',
                    'route_is' => 'admin.crm.pipeline',
                ],
                [
                    'label_ar' => 'كل الفرص (مدارس / معلمون)',
                    'label_en' => 'All leads (schools / teachers)',
                    'route' => 'admin.crm.leads.index',
                    'route_is' => 'admin.crm.leads.*',
                ],
                [
                ...
                [
                    'label_ar' => 'سجل نشاط البيع',
                    'label_en' => 'Sales activity log',
        ...
        'users' => [
            'hub' => 'comms',
            'label_ar' => 'المعلمون والمتعلمون',
            'label_en' => 'Teachers & learners',
            'icon' => 'fas fa-users',
            'permissions' => ['manage.users'],
            'note_ar' => 'حسابات الأفراد على المنصة — المدربون للتنفيذ تحت «تعاقد مباشر»',
            'note_en' => 'Individual accounts — delivery coaches live under Direct contract',
            'items' => [
                [
