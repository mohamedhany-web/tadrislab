...
<div class="mx-auto max-w-3xl space-y-5">
    ...
    @endif
    <form method="POST" action="{{ route('admin.institutions.store') }}" class="space-y-4 rounded-2xl border border-line bg-surface p-5 shadow-soft">
        @csrf
        @include('admin.institutions._form', ['institution' => null, 'field' => $field, 'area' => $area, 'orgTypes' => $orgTypes])
