...
<head>
    ...
    <title><?php echo e(config('app.name')); ?> — <?php echo $__env->yieldContent('title', __('instructor.overview')); ?></title>
    ...
    <link rel="stylesheet" href="<?php echo e(route('assets.student-timeline.css')); ?>?v=<?php echo e($stCssVer); ?>">
    <?php
        $ipCssFile = public_path('css/instructor-panel.css');
        $ipCssVer = is_file($ipCssFile) ? (string) filemtime($ipCssFile) : (string) time();
    ?>
    <link rel="stylesheet" href="<?php echo e(asset('css/instructor-panel.css')); ?>?v=<?php echo e($ipCssVer); ?>">
    <link rel="stylesheet" href="<?php echo e(asset('css/instructor-st-bridge.css')); ?>?v=<?php echo e($stCssVer); ?>">
    <script>
        (function () {
            try {
...
<div class="st-shell is-wide<?php echo e($appRtl ? ' is-rtl' : ' is-ltr'); ?>" id="stShell">
    <script>
    (function () {
    ...
    <aside class="st-rail" id="stRail" aria-label="<?php echo e(__('instructor.overview')); ?>">
        ...
        <a href="<?php echo e(Route::has('instructor.profile') ? route('instructor.profile') : route('dashboard')); ?>" class="st-rail__profile" title="<?php echo e(__('instructor.profile')); ?>">
    ...
    <main class="st-main st-coach-main">
        <?php if(! View::hasSection('hide_st_top')): ?>
        ...
        <?php if(session('error')): ?>
            <div class="st-flash st-flash--err"><?php echo e(session('error')); ?></div>
        <?php endif; ?>
...
<?php /**PATH /Users/cityphone/Documents/tadris lab/resources/views/layouts/instructor-timeline.blade.php ENDPATH**/ ?>